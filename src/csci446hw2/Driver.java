...
public class Driver {
    ...
    /**
     * @param args The command line arguments Takes in the path to the file
     * containing the maze
     *
        ...
        if (args.length > 0) {
            for (int i = 0; i < args.length; i++) {
                for (int j = 0; j < 2; j++) {
                    ...
                    // The only difference between the dumb algorithm
                    // and the smart algorithm is if you order the domain
            ...
            System.out.println("Please give an argument of the filename of the "
                    + "maze you want to solve to the program.");
        }
    }
}
